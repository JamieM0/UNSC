...
public class Main {
    public static void main(String[] args) {
        ...
        System.out.println("It looks like it's your first time using UNSC. To convert to and from different number systems, use the standard prefixes.\n" +
                ...
                "You can also use this format 10:29384 2 to get the same result.\n\n" +
        ...
        while (1 == 1) {
            ...
            try {
                ...
                try{
                    int baseSeparator = input.indexOf(":");
                    int conversionSeparator = input.indexOf(" ");
                    inputBase = Integer.parseInt(input.substring(0, baseSeparator));
                    inputVal = input.substring(baseSeparator + 1, conversionSeparator);
                    outputBase = Integer.parseInt(input.substring(conversionSeparator+1));
                    String out = Converter.Conversion(inputBase, outputBase, inputVal);
                    System.out.println("The result of the conversion is: " + out);
                }
                catch(Exception ex2){
                    System.out.println("Sorry, there was an error with the input. Please try again. Error: " + ex2.getMessage());
                    System.out.println("");
                }
            }
